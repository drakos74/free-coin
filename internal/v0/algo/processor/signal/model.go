...
// Processor defines the next processor interface
type Processor struct {
	// User is the user identifier for the processor
	User string
	// Channel is the input channel for the processor
	Channel chan *model.TrackedOrder
}
